...
exports.LMSChannel = exports.PUBLMS = exports.SUBLMS = void 0;
class SUBLMS {
    makeSubHtml() {
    ...
    makeSubJS(lwcname, channelname, fieldName) {
...
class PUBLMS {
    ...
    makePubJS(lwcname, channelname, fieldName) {
        const JScode = 'import { api,wire,LightningElement }from \'lwc\';' + '\n' +
            '//import apexMethodName from \'@salesforce/apex/Classname.apexMethod\';' + '\n' +
