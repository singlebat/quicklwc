export class Parent {
     ...
     makeParentHtml(childLWCname : string) {
        //childLWCname need to be lowercase
        const Htmlcode ='<template>'+'\n'+
                            '\t<lightning-card>'+'\n'+
                            '\t<h2>parent lwc</h2>'+'\n'+
                            '\t<p class="slds-p-horizontal_small">'+'\n'+
                            '\t\t<c-'+childLWCname+' child-value={value1}  lowercasevalue={value2} oncumtomeventname={CalledFromChild}></c-'+childLWCname+'>'+'\n'+
    ...
    makeParentJS(lwcname : string,childLWCname : string) {
